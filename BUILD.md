...
For local development, the `dev-fast` profile has a lower optimization level and should have faster incremental compile times (at the cost of worse runtime performance):
