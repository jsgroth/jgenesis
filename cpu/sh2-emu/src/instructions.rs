...
fn decode_inner(opcode: u16) -> OpcodeFn {
    match opcode & 0b1111_0000_0000_1111 {
        ...
        _ => match opcode & 0b1111_0000_1111_1111 {
            ...
            0b0000_0000_0010_0011 => cpu_op_bus!(branch::braf),
            0b0000_0000_0000_0011 => cpu_op_bus!(branch::bsrf),
            0b0100_0000_0010_1011 => cpu_op_bus!(branch::jmp),
            0b0100_0000_0000_1011 => cpu_op_bus!(branch::jsr),
            ...
            0b0000_0000_0000_1011 => |cpu, _, bus| branch::rts(cpu, bus),
            ...
            _ => match opcode & 0b1111_0000_0000_0000 {
                ...
                0b1010_0000_0000_0000 => cpu_op_bus!(branch::bra),
                0b1011_0000_0000_0000 => cpu_op_bus!(branch::bsr),
                ...
                0b1000_0000_0000_0000 => |cpu, opcode, bus| match (opcode >> 8) & 0b1111 {
                    ...
                    0b1001 => branch::bt(cpu, opcode, bus),
                    0b1011 => branch::bf(cpu, opcode, bus),
                    0b1101 => branch::bt_s(cpu, opcode, bus),
                    0b1111 => branch::bf_s(cpu, opcode, bus),
